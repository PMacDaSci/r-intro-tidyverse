...
In our expression table there should be just *one column containing all expression values* instead of multiple columns with counts for each sample. We can use tidyr's `gather()` to easily change the format.
