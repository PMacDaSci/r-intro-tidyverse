...
* Extra task is to identify the recurrance patients where the recurrance is in the same location. The location is given in the column called breast_side. Hint: use dplyr's group_by function followed by filter. Write out the file as `redcap_recur_same_loc.csv`
