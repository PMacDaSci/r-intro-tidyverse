...
You've been studying the RNA-seq basal anad luminal samples from the mouse model of breast cancer in this course. Now you want to check the expression of some genes in human basal and luminal breast cancer samples. You decide to use the [TCGA breast cancer](https://www.nature.com/articles/nature11412) dataset as it has many (hundreds) of samples and the RNA-seq counts are available to download.
