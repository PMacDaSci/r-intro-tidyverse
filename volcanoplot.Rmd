...
Make a volcano plot labelling the top 10 genes.
This is very similar to what we did for the genes of interest (`goi`) e.g. you will need to extract the gene symbols from the `top10` info and store them in an object called `top10_syms`, then add a column called e.g. top10 to the de_results that says which genes to label.
