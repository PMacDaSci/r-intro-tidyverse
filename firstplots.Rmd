...
The counts file we will use is stored on the server at the location `/training/r-intro-tidyverse/data/counts.tsv.gz`.
...
#### Exercise
* Read in the normalised counts (from "/training/r-intro-tidyverse/data/normcounts.tsv.gz"). This is the `counts` data after filtering lowly expressed genes and normalising for differences in sequencing depth and composition bias.
